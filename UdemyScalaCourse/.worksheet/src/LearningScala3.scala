object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def func1( x: String) : String ={
  	x.toUpperCase
  	};System.out.println("""func1: (x: String)String""");$skip(20); val res$3 = 
  	func1("Hellooo");System.out.println("""res3: String = """ + $show(res$3));$skip(73); 
  
  def transformString(x:String, f: String=> String) : String= { f(x)};System.out.println("""transformString: (x: String, f: String => String)String""");$skip(48); val res$4 = 
  transformString("ooijnjkni",x=>x.toUpperCase);System.out.println("""res4: String = """ + $show(res$4))}
